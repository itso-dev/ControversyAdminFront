<template>
  <div class="px-8 py-8 ">
    ...
    <p class="text-center font-bold text-3xl mb-16 text-primary">{{this.title}}</p>
    ...
    <div class="flex mb-10 w-4/5 m-auto align-middle">
      <div class="w-2/5">
        ...
        <p class="font-bold text-2xl mb-2 text-center">{{this.explanation1}}</p>
        <p class="font-bold text-3xl text-center">{{this.insertComma(this.type1CntTotal)}}</p>
      </div>
      <div class="w-1/5 text-center flex justify-center items-center">
        <span class="font-extrabold text-5xl text-[#999]">VS</span>
      </div>
      <div class="w-2/5">
        <img class="w-full rounded-2xl mb-5" :src="getFirstImagePath(this.file2)">
        <p class="font-bold text-2xl mb-2 text-center">{{this.explanation2}}</p>
        <p class="font-bold text-3xl text-center">{{this.insertComma(this.type2CntTotal)}}</p>
      </div>
    </div>
